// To parse this data:
//
//   import { Convert, PokeService } from "./file";
//
//   const pokeService = Convert.toPokeService(json);
//
...
export class Convert {
    public static toPokeService(json: string): PokeResponse {
        return cast(JSON.parse(json), r("PokeResponse"));
    }

    public static pokeServiceToJson(value: PokeResponse): string {
